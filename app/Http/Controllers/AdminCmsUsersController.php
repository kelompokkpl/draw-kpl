...
class AdminCmsUsersController extends CBController {
	...
	public function cbInit() {
		...
		$this->form[] = array("label"=>"Photo","name"=>"photo","type"=>"upload","help"=>"Recommended resolution is 200x200px", 'validation'=>'mimes:jpg,jpeg,bmp,svg,png|max:1000','resize_width'=>90,'resize_height'=>90);						

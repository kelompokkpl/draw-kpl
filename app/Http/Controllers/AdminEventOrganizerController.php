<?php namespace App\Http\Controllers;
	...
	class AdminEventOrganizerController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:6|max:100|email|unique:cms_users','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			$this->form[] = ['label'=>'Cms Privileges','name'=>'id_cms_privileges','type'=>'hidden','validation'=>'min:1','width'=>'col-sm-10'];

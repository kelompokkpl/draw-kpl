...
<div class='panel panel-default' id="root">
    <div class="panel-body">
        <form method="POST" action="{{route('event.update', $event->id)}}" id="form">
          @csrf
          @method('PUT')
          <div class='form-group header-group-0 ' id='form-group-name' style="">
            ...
            <div class="col-sm-10">
              <input type='text' title="Name" required  placeholder='You can only enter the letter only'  maxlength=100 class='form-control' name="name" id="name" value='{{$event->name}}'/>
          ...
          <div class='form-group form-datepicker header-group-0 ' id='form-group-date_start' style="">
            ...
            <div class="col-sm-10">
              <input type='date' title="Date Start" required class='form-control notfocus input_date' name="date_start" id="date_start" value='{{$event->date_start}}'/>
              <div class="text-danger"></div>
              <p class='help-block'></p>
            </div>
          </div>
          <div class='form-group form-datepicker header-group-0 ' id='form-group-date_end' style="">
            ...
            <div class="col-sm-10">
              <input type='date' title="Date End" required class='form-control notfocus input_date' name="date_end" id="date_end" value='{{$event->date_end}}'/>
              <div class="text-danger"></div>
              <p class='help-block'></p>
            </div>
          </div> 
